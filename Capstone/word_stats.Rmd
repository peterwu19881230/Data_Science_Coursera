...
#### Please refer to the original code here: https://github.com/peterwu19881230/datasciencecoursera/blob/master/Capstone/word_stats.Rmd
...
```{r,tidy=T,cache=T,echo=FALSE, message=F}
...
# <br/> Summary statistics for 3 different text files.
...
#Word frequencies of the corpus (3 files combined)
```{r,tidy=T,echo=FALSE, message=F}
...
#Proposal
#### I propose to use the above model built to predict the next word upon entry. The shiny app to be built will include a text box that allows user to enter their favorite text and show what's the next word. If there is no prediction, the ouput will show "no predicted result available" 
```{r,tidy=T,echo=FALSE, message=F,fig.width=14, fig.height=7}
